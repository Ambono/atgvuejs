  ...
  context('Local Storage', function () {
    ...
    it('cy.clearLocalStorage() - clear all data in local storage', function () {
      ...
      cy.get('.ls-btn').click().should(function () {
        expect(sessionStorage.getItem('prop1')).to.eq('red')
        expect(sessionStorage.getItem('prop2')).to.eq('blue')
        expect(sessionStorage.getItem('prop3')).to.eq('magenta')
      })

      // clearLocalStorage() yields the sessionStorage object
